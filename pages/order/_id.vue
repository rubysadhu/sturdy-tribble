...
<div class="container mx-auto">
  ...
  <div class="rounded shadow p-5 pb-5 border-2 border-gray-400 bg-gray-100">
    ...
    <div class="grid grid-cols-3 gap-4">
      ...
      <div class="flex flex-col items-center text-center justify-center">
        <lottie-player src="https://assets7.lottiefiles.com/packages/lf20_w0cYJr.json" background="transparent" speed="1" style="width: 200px; height: 200px;" loop autoplay></lottie-player>
      ...
      <div :class="order.confirmed ?  'opacity-100' : 'opacity-25'" class="flex flex-col items-center text-center justify-center">
        ...
        <lottie-player src="https://assets1.lottiefiles.com/temp/lf20_dRqSdi.json" background="transparent" speed="1" style="width: 200px; height: 200px;" loop autoplay></lottie-player>
      ...
      <div :class="order.completed ?  'opacity-100' : 'opacity-25'" class="flex flex-col items-center text-center justify-center opacity-25">
        ...
        <lottie-player src="https://assets4.lottiefiles.com/temp/lf20_uD5mKa.json" background="transparent" speed="1" style="width: 200px; height: 200px;" loop autoplay></lottie-player>
  ...
  <zoom-center-transition>
    <div v-if="order.completed" class="happyBear">
      <img class="rounded shadow-lg border-2 border-gray-900" src="https://media1.giphy.com/media/9Y6n9TR7U07ew/giphy.gif?cid=ecf05e479d05907f698bf566621351d21e9e4c2c905b978b&rid=giphy.gif">
    </div>
  </zoom-center-transition>
