...
<div class="">
  ...
  <slide-y-up-transition>
    ...
    <div v-if="viewOrderPopup" class="bg-white relative rounded-md p-6 shadow-md" style="left: 5%;top:5%;position: fixed;width: 90%;z-index: 999">
      ...
      <div class="mt-5">
        ...
        <div v-if="!viewedOrder.confirmed" @click="confirmOrder(viewedOrder)" class="bg-green-500 flex-grow text-white text-center uppercase  flex-grow cursor-pointer text-white text-2xl font-bold py-3 px-6 rounded">Confirm Order</div>
      </div>
    </div>
  ...
  <div class="grid grid-cols-3 gap-0 h-screen overflow-hidden">
    ...
    <div class="border-r border-gray-300">
      ...
      <div class="p-5 overflow-y-scroll" style="position: relative;height: 100vh;padding-bottom: 300px">
